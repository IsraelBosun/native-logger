    ...
    <View style={[tw`flex-1 bg-white`, {backgroundColor: themeColors.bg}]}>
      ...
      <View style={[tw`flex-1 bg-white px-8 pt-8 mt-2`, {borderTopLeftRadius: 50, borderTopRightRadius: 50}]}>
        <View style={tw`flex my-2 `}>
          ...
          <TextInput style={tw`p-4 bg-gray-100 text-gray-700 rounded-2xl mb-3`} value='Israel Lee' placeholder='Enter Fullname' />
          ...
          <TextInput style={tw`p-4 bg-gray-100 text-gray-700 rounded-2xl mb-7`} secureTextEntry value='test1234' placeholder='Enter Password' />
